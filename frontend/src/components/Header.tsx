...
import { useGetCallerUserProfile, useBootstrapAuthRegistration } from '../hooks/useQueries';
...
export default function Header() {
  ...
  const { bootstrapComplete } = useBootstrapAuthRegistration();
  const { data: userProfile } = useGetCallerUserProfile(!!identity && bootstrapComplete);
