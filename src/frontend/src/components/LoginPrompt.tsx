      ...
      <div className="max-w-4xl mx-auto">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-background/90 to-transparent flex items-end">
            <div className="p-8">
              <h2 className="text-3xl font-bold text-foreground mb-2">
                Welcome to Pepper Farm Bookkeeping
              </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-card border border-border rounded-lg p-6">
            <div className="flex items-center gap-3 mb-4">
              <img
                src="/assets/generated/income-icon-transparent.dim_64x64.png"
                alt="Income"
                className="w-12 h-12"
              />
            ...
            <p className="text-muted-foreground">
              Record and categorize all your farm income and expenses with
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            ...
            <p className="text-muted-foreground">
              Track peppers, fertilizers, pesticides, and equipment with
              real-time quantity and value monitoring.
            </p>
          </div>
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            ...
            <p className="text-muted-foreground">
              Maintain customer records and view complete purchase history for
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            ...
            <p className="text-muted-foreground">
              View comprehensive financial summaries including profit/loss,
              inventory value, and recent transactions.
            </p>
          </div>
        </div>
        ...
        <div className="text-center">
          <p className="text-lg text-muted-foreground mb-4">
            Please login to access your farm bookkeeping system
          </p>
