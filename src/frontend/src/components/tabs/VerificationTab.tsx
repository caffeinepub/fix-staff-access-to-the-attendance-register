      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Manage user access and approval requests
          </p>
        </div>
        <Button
          variant="outline"
                  ...
                  pending.map((approval) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell>
                          <Badge
                            variant={statusColors[approval.status] ?? "outline"}
                            className="gap-1"
                          >
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    Grant access to this user? They will be able
                                    to view all farm data.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    Deny access to this user? They will see a
                                    rejection message when they log in.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                                  <AlertDialogCancel>Cancel</AlertDialogCancel>
