      ...
      <Card className="max-w-md w-full border-border shadow-lg">
        ...
        <CardContent className="space-y-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  An existing verified farm member will review your account and
                  grant you access to the farm management dashboard.
                </p>
              </div>
            </div>
          </div>
            ...
            {!requested ? (
              ...
              <div className="text-center py-2">
                <p className="text-sm text-primary font-medium">
                  ✓ Approval request sent! Please wait for a farm member to
                  review your account.
                </p>
              </div>
            )}
          ...
          <p className="text-xs text-center text-muted-foreground">
            If you believe this is an error, please contact your farm
            administrator.
          </p>
        </CardContent>
      </Card>
